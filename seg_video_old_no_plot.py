...
def FrameCapture(video_path, model):
    ...
    for i in range(len(images)):
        ...
        end2=time.time()
        list_without_plot.append(end2-start2)
    ...
    end1=time.time()
    print("The time taken to process all the images without plotting",end1-start1)
    print("Time taken for each image without plot",list_without_plot)
