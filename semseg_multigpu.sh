...
#SBATCH --output=log_outputs/semseg_out_drn_d_54%J.out
...
# pconfig_path=sparse_experiments/srmbrep_cityscapes_drn_d_22/sparse_srmbrep_cityscapes_drn_d_22_srmbrep_512X512_-1x-1_-1x-1_2x2_0.00-RAMANUJAN_50.00-RAMANUJAN_50.00_collapse_repetitive/config.json
...
python semantic_seg_multigpu.py --dist-url 'tcp://127.0.0.1:2323' --dist-backend 'nccl' --world-size 2 --rank 0 train -d /ssd_scratch/cvit/furqan.shaik/cityscapes/cityscapes \
         --dataset cityscapes \
         --arch drn_d_54 \
         --exp_dir sparse_experiments/srmbrep_cityscapes_drn_d_54/sparse_srmbrep_cityscapes_drn_d_54_srmbrep_1024X768_-1x-1_-1x-1_2x2_0.00-RAMANUJAN_50.00-RAMANUJAN_50.00_collapse_repetitive \
         --mc_pruning \
         --pr_config_path sparse_experiments/srmbrep_cityscapes_drn_d_54/sparse_srmbrep_cityscapes_drn_d_54_srmbrep_1024X768_-1x-1_-1x-1_2x2_0.00-RAMANUJAN_50.00-RAMANUJAN_50.00_collapse_repetitive/config.json \
         --pr-static \
         --lr 0.01 \
		 --input_size '1024X768' \
         --epochs 500 -b 10 | tee sparse_experiments/srmbrep_cityscapes_drn_d_54/sparse_srmbrep_cityscapes_drn_d_54_srmbrep_1024X768_-1x-1_-1x-1_2x2_0.00-RAMANUJAN_50.00-RAMANUJAN_50.00_collapse_repetitive/log_500.txt
